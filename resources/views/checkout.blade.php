        ...
        <div class="container p-12 mx-auto">
            <div class="flex flex-col w-full px-0 mx-auto md:flex-row">
                <div class="flex flex-col md:w-full">
                    ...
                    <form class="justify-center w-full mx-auto" action="{{ route('checkout.store') }}" method="POST">
                            @csrf
                        <div class="">
                            ...
                            <div class="space-x-0 lg:flex lg:space-x-4 mt-4">
                                ...
                                <div class="w-full lg:w-1/2 ">
                                    <label for="Number" class="block mb-3 text-sm font-semibold text-gray-500">Number</label>
                ...
                <div class="flex flex-col w-full ml-0 lg:ml-12 lg:w-2/5">
                    <div class="pt-12 md:pt-0 2xl:ps-4">
                        ...
                        <div class="mt-8">
                            <div class="flex flex-col space-y-4">
                                <div class="flex space-x-4">
                                    <div>
                                        <img src="{{ $item->attributes->image }}" alt="image"
                                            class="w-60">
                                    </div>
                                    <div>
                                        <h2 class="text-xl font-bold">{{ $item->name }}</h2>
                                        <p class="text-sm">Price</p>
                                        <span class="text-red-600"></span>${{ $item->price}}
                                    </div>
                                    <div>
                                    <form action="{{ route('checkout.remove') }}" method="POST">
                                  @csrf
                                  <input type="hidden" value="{{ $item->id }}" name="id">
                                  <button class="font-medium text-indigo-600 hover:text-indigo-500"> <svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6" fill="none"
                        ...
                        <div
                            ...
                            Subtotal<span class="ml-2">{{ $subTotalWithoutConditions = Cart::getSubTotalWithoutConditions() }}</span></div>
                        <div
                            class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Tax<span class="ml-2">{{ $condition = Cart::getCondition('VAT 12.5%');}}</span></div>
                        <div
                            class="flex items-center w-full py-4 text-sm font-semibold border-b border-gray-300 lg:py-5 lg:px-3 text-heading last:border-b-0 last:text-base last:pb-0">
                            Total<span class="ml-2">${{ Cart::getTotal() }}</span></div>
                    </div>
