...
@section('content')
          <main class="my-8">
            ...
            <div class="pointer-events-auto w-46">
        ...
        <div class="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                ...
                <ul role="list" class="-my-6 divide-y divide-gray-200">
                  <li class="flex py-6">
                    <div class="h-24 w-24 flex-shrink-0 overflow-hidden rounded-md border border-gray-200">
                      <img src="{{ $item->attributes->image }}" class="h-full w-full object-cover object-center">
                    </div>
                    ...
                    <div class="ml-4 flex flex-1 flex-col">
                      ...
                      <form action="{{ route('cart.update') }}" method="POST">
                                      @csrf
                                      <input class="text-center" type="hidden" name="id" value="{{ $item->id}}" >
          ...
          <div class="border-t border-gray-200 py-6 px-4 sm:px-6">
            ...
            <div class="mt-6 flex justify-center text-center text-sm text-gray-500">
              <p>
                or <a href="/" type="button" class="font-medium text-indigo-600 hover:text-indigo-500">Continue Shopping<span aria-hidden="true"> &rarr;</span></a>
              </p>
            </div>
          </div>
        </div>
