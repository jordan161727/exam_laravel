...
<div class="overflow-x-auto shadow-md sm:rounded-lg">
    <div class="inline-block min-w-full align-middle">
        ...
        <li class=" pr-9 py-3 flex items-center justify-between text-sm">
              ...
              <a href="{{ url('category') }}" class=" flex items-center justify-between font-medium text-bold text-indigo-600 hover:text-indigo-500 ">
            ...
            <table class="min-w-full w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                ...
                <tbody class="bg-white divide-y  divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $categories->id }}</td>
                        ...
                        <a href="{{ route('category.restore',$categories->id) }}" class="text-blue-600 dark:text-blue-500 hover:underline">Restore</a>
                            <a href="{{ route('category.force-delete',$categories->id) }}" class="text-red-600 dark:text-blue-500 hover:underline">Delete</a>
                        </td>
                    </tr>
