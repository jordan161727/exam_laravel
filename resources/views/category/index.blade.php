            ...
            <div class="bg-white h-full rounded-2xl dark:bg-gray-700">
                ...
                <nav class="mt-6">
                    ...
                    <a class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="{{ url('/login') }}">
                            ...
                            <a class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="{{ url('/product') }}">
                            <span class="text-left">
                        ...
                        <a class="w-full font-thin uppercase text-blue-500 flex items-center p-4 my-2 transition-colors duration-200 justify-start bg-gradient-to-r from-white to-blue-100 border-r-4 border-blue-500 dark:from-gray-700 dark:to-gray-800 border-r-4 border-blue-500" href="{{ url('/category') }}">
                            <span class="text-left">
                                <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <a class="w-full font-thin uppercase text-gray-500 dark:text-gray-200 flex items-center p-4 my-2 transition-colors duration-200 justify-start hover:text-blue-500" href="{{ url('/category') }}">
                            <span class="text-left">
                                <svg width="20" height="20" fill="currentColor" class="m-auto" viewBox="0 0 2048 1792" xmlns="http://www.w3.org/2000/svg">
...
<div class="overflow-x-auto shadow-md sm:rounded-lg">
    <div class="inline-block min-w-full align-middle">
      ...
      <a href="{{ route('category.create') }}" class=" flex items-center justify-between font-medium text-bold text-indigo-600 hover:text-indigo-500 "><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
</svg>Add Product</a>
<div class="pl-3">
<a href="{{ url('categories/trash') }}"><button class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
 Go to Trash
      </a></button>
 </div>
</div>
            ...
            <table class="min-w-full w-full divide-y divide-gray-200 table-fixed dark:divide-gray-700">
                ...
                <tbody class="bg-white divide-y  divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $categories->id }}</td>
                        <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $categories->name }}</td>

                       
                        <td class="py-4 px-6 text-sm font-medium text-right whitespace-nowrap pr-10">
                        <form action="{{ route('category.destroy',$categories->id) }}" method="Post">
                       
                            <a href="{{ route('category.edit',$categories->id) }}" class="text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            @csrf
@method('DELETE')
