...
<div class="overflow-x-auto shadow-md sm:rounded-lg">
    <div class="inline-block min-w-full align-middle">
      ...
      <a href="{{ route('product.create') }}" class=" flex items-center justify-between font-medium text-bold text-indigo-600 hover:text-indigo-500 "><svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v3m0 0v3m0-3h3m-3 0H9m12 0a9 9 0 11-18 0 9 9 0 0118 0z" />
</svg>Add Product</a>
<div class="pl-3">
<a href="{{ url('products/trash') }}"><button class="bg-red-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-full">
 Go to Trash
      </a></button>
 </div>
</div>
                ...
                <tbody class="bg-white divide-y  divide-gray-200 dark:bg-gray-800 dark:divide-gray-700">
                    ...
                    <td class="py-4 px-6 text-sm font-medium text-gray-900 whitespace-nowrap dark:text-white">{{ $company->id }}</td>
                        ...
                        <form action="{{ route('product.destroy',$company->id) }}" method="Post">
                            ...
                            <a href="{{ route('product.edit',$company->id) }}" class="text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                            @csrf
@method('DELETE')
